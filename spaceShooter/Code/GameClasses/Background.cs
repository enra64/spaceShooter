...
namespace spaceShooter.Code.GameClasses {
    class Background {
        ...
        private RenderTexture background = new RenderTexture(16384, 16384);
        private Sprite[] bgSprite = new Sprite[4];
        ...
        public Background() {
            ...
            foreach (Sprite s in starList)
                background.Draw(s);
            bgSprite[0] = new Sprite(background.Texture);
            bgSprite[1] = new Sprite(background.Texture);
            bgSprite[2] = new Sprite(background.Texture);
            bgSprite[3] = new Sprite(background.Texture);
        }
